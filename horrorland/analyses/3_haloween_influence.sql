SELECT
    CASE
        WHEN f.days_before_halloween BETWEEN 6 AND 0 THEN 'Semana do Halloween (25-31 Out)'
        WHEN f.days_before_halloween BETWEEN 5 AND 1 THEN 'Véspera do Halloween (26-30 Out)'
        WHEN f.days_before_halloween = 0 THEN 'Dia do Halloween (31 Out)'
