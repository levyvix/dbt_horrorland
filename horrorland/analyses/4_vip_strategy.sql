SELECT
    ...
    AVG(CASE WHEN c.customer_category = 'Regular Visitor' AND f.ticket_type = 'VIP' THEN 1.0 ELSE 0.0 END) as regular_to_vip_rate
...
GROUP BY f.ticket_type, c.customer_category, h.fear_category, h.size_category
ORDER BY f.ticket_type DESC, avg_rating DESC